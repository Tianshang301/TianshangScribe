...
from tianshang_scribe.core.document import DocumentType, detect_document_type
from tianshang_scribe.utils.file_utils import check_overwrite as _check_overwrite
